YANDEX_LEADERBOARD = {
	...
	onLeaderboardEntriesReceived(data = null) {
		...
		data.leaderboard.title = data.leaderboard.title || {};
	...
	updateOverlay: function() {
		...
		entries.forEach(entry => {
			entry.isPlayersEntry = typeof this.data.player === "undefined" ? false : (entry.player.uniqueID == this.data.player.uniqueID);
